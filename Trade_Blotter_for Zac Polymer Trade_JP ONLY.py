# -*- coding: utf-8 -*-
"""
Created on Tue Apr  7 15:31:30 2020
...
PM_enail_mapping = {"AGINE":"tyin@pag.com;zzhang@pag.com;johnathanl@pag.com",
                     "KYAHA":"tyin@pag.com;zzhang@pag.com;johnathanl@pag.com",
                     "AFUKU":"tyin@pag.com;zzhang@pag.com;johnathanl@pag.com",
                     "KNAKA":"tyin@pag.com;zzhang@pag.com;johnathanl@pag.com",
                     "KYOSH":"tyin@pag.com;zzhang@pag.com;johnathanl@pag.com",
                     "MYAMA":"tyin@pag.com;zzhang@pag.com;johnathanl@pag.com",
                      }
...
Trade_Blotter_Data_allPM=Trade_Blotter_Data_allPM[Trade_Blotter_Data_allPM["Trade Currency"].str.contains("JPY")]
...
for PM in All_PM_names:   
    ...
    if Trade_Blotter_Data.empty == True: 
        ...
        import pdblp
        con = pdblp.BCon(debug=True, port=8194, timeout=90000)
        con.start()
